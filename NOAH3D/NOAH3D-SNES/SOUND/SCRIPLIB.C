...
//-------------------------------------------------------------------
// UnGetToken		Signals that the current token was not used, and
//						should be reported for the next GetToken.  Note
//						that
//
//							GetToken (true);
//							UnGetToken ();
...
//-------------------------------------------------------------------
// TokenAvailable()	Returns true if there is another token on the line
//-------------------------------------------------------------------
